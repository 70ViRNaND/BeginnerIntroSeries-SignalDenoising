...
fs = 5000; %sampling frequency to generate time domain signal
...
subset_filtered = filtered(2501:7500); %make sure length of filtered signal equals to length of original signal
