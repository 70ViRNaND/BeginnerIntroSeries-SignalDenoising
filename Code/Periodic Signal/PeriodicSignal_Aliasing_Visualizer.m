...
%set coefficient, time and frequency for "continous time" sinusoids
coef1 = 20;
coef2 = 8;
coef3 = 1;
tMax = 1 ;
...
xCont = coef1*sin(2*pi*f1*t)  + coef2*cos(2*pi*f2*t) + coef3*sin(2*pi*f3*t) ;
xSamp_1 = coef1*sin(2*pi*f1*tSamp_1) + coef2*cos(2*pi*f2*tSamp_1) + coef3*sin(2*pi*f3*tSamp_1);
xSamp_2 = coef1*sin(2*pi*f1*tSamp_2) + coef2*cos(2*pi*f2*tSamp_2) + coef3*sin(2*pi*f3*tSamp_2);
xSamp_3 = coef1*sin(2*pi*f1*tSamp_3) + coef2*cos(2*pi*f2*tSamp_3) + coef3*sin(2*pi*f3*tSamp_3);
xSamp_4 = coef1*sin(2*pi*f1*tSamp_4) + coef2*cos(2*pi*f2*tSamp_4) + coef3*sin(2*pi*f3*tSamp_4);
...
if fs_1 < 2 * f1 || fs_1 < 2 * f2 || fs_1 < 2 * f3
   ...
   if ctrl1 < 0 && ctrl3 < 0
    ...
    plot(t,  -coef1*sin(2*pi*fAlias1*t)+ coef2*cos(2*pi*fAlias2*t) -coef3*sin(2*pi*fAlias3*t), 'r', 'linewidth', 2) ;
...
suptitle(['f(t) =' num2str(coef1) ' sin(2*pi*4*t) +' num2str(coef2) 'cos(2*pi*8*t) +' num2str(coef3) 'sin(2*pi*16*t)'])
